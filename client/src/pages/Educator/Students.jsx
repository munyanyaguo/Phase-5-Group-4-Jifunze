// src/pages/educator/Students.jsx
import { useState } from "react";
import { UserPlus, Trash2, BookOpen } from "lucide-react";
import UserForm from "../../components/educator/UserForm";
...
export default function Students() {
  const [students, setStudents] = useState([
    ...
    { id: 3, name: "Carol Wambui", email: "carol@example.com", className: "Class A" },
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold text-gray-800">My Students</h2>
        <button
        ...
        {students.map((s) => (
          ...
          >
            ...
            <div className="flex items-center gap-2 mt-3 text-sm text-green-600">
              <BookOpen size={16} /> Good Performance
            </div>
